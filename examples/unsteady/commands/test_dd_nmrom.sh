...
#SBATCH -e dd_nmrom_3_err.txt      #stderr
#SBATCH -o dd_nmrom_3_out.txt      #stdout
#SBATCH -J dd_nmrom_3              #name of job
...
load_conda_env_toss
### Launch program
python -u ./../scripts/test_dd_nmrom.py --inpfile ./../inputs/test_dd_nmrom_3.json
